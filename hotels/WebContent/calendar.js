...
function dis()
{
  q++;
  var c=q%6;
  var na= 'images/'+'a'+c+'.jpg';
 document.getElementById('gallery').src=na;
 document.getElementById('gallery').width='500';
 document.getElementById('gallery').height='400';
...
{
if (form.datum1.value == "") 
{
alert( "Please enter check in Date." );
form.datum1.focus();
return false ;
}
if (form.datum2.value == "") 
{
